...
9. Omit any section or subsection that has no stories or items. Never write "None" as a placeholder — simply omit the entire subsection. An absent subsection is better than an empty one.
